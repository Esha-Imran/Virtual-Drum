...
class VirtualDrum:
    ...
    def application(self):
        ...
        resized_drum = cv2.resize(drum2left, (self.wd1, self.hd1))
            ...
            if ret:
                ...
                if len(contours) > 0 and cv2.contourArea(max(contours, key = cv2.contourArea)) > 450:
                    ...
                    if found:
                        ...
                        if touching == False:
                            playsound(self.drumsl[index], False)
                            touching = True
                        ...
                        if found:
                            ...
                            if touching == False:
                                playsound(self.ringsI[index],False)
                                touching = True
...
black_button_student = Button(window_frame,image=img3, bd=0, command=obj1.finding_color,bg="#101010")
black_button_student.place(x=200, y=450)
black_button_teacher = Button(window_frame,image=img4, bd=0, command=obj2.application,bg="#101010")
black_button_teacher.place(x=640, y=450)
